...
// Helper function to log with automatic source detection
export const log = (message: string, data?: any, source?: string) => {
  browserLogger.log(message, data, source);
};

export const logInfo = (message: string, data?: any, source?: string) => {
  browserLogger.info(message, data, source);
};

export const logWarn = (message: string, data?: any, source?: string) => {
  browserLogger.warn(message, data, source);
};

export const logError = (message: string, data?: any, source?: string) => {
  browserLogger.error(message, data, source);
};

export const logDebug = (message: string, data?: any, source?: string) => {
  browserLogger.debug(message, data, source);
};
